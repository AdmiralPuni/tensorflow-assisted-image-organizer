...
def main(argv):
  ...
  character_names = ['hololive', 'myusu']
  model_filename = 'model-general-model.hdf5'
  #character_names.append(settings_json['models'][selected_model]['names'])
  #model_filename.append(settings_json['models'][selected_model]['filename'])
  ...
  def get_name(cropped_image, model_index = 1):
